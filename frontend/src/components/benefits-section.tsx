          ...
          <div className="animate-on-scroll opacity-0 translate-y-10 transition-all duration-700 delay-300">
            <GlassmorphicCard className="p-8 md:p-12 relative overflow-hidden">
              ...
              <h3 className="text-2xl md:text-3xl font-bold mb-8 gradient-text">
                Why Avalanche for Your<br />Hackathon Project?
              </h3>
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    Avalanche is the first carbon-negative blockchain, making it perfect for sustainable and eco-friendly applications.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-daoship-text-gray/80">
                    Avalanche's Pure Proof-of-Stake consensus mechanism provides security, scalability, and instant finality.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-daoship-text-gray/80">
                    Avalanche Smart Contracts (ASC1) are powerful, secure, and cost-effective for building decentralized applications.
                    </p>
                  </div>
                </div>
          ...
          <div>
            <div className="animate-on-scroll opacity-0 translate-y-10 transition-all duration-700 delay-100 space-y-8">
              ...
              <p className="text-xl text-daoship-text-gray/80">
                DAOShip makes it simple to create and manage decentralized autonomous organizations on the Avalanche blockchain.
              </p>
              ...
              <div className="relative overflow-hidden rounded-2xl">
                <img 
                  src="https://placehold.co/800x500/0FA0CE/FFFFFF/png?text=Avalanche+Ecosystem" 
                  alt="Avalanche Ecosystem" 
                ...
                <div className="absolute bottom-0 left-0 p-6">
                  <h4 className="text-white text-xl font-bold">Join the Avalanche Ecosystem</h4>
